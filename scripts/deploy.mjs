...
const ITEMS = ['package.json', 'lib', 'scripts', 'cordis.patch.yml', 'README.md', 'LICENSE']
...
if (!existsSync(GUARDIAN)) {
  ...
  console.error('safe snapshot deployment requires dsh-desktop Guardian; normal npm/GitHub plugin installation remains supported.')
  process.exit(1)
}
