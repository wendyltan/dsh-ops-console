      ...
      el(Card, {
        ...
        !confirm
          ...
          : el("div", { className: "dshops-row" },
              ...
              el(Btn, { danger: true, disabled: restarting || g?.available !== true, onClick: doRestart }, restarting ? t("server.restarting") : t("server.confirmBtn")),
              el(Btn, { onClick: () => setConfirm(false) }, t("server.cancel")),
            ),
      ),
      el(Card, {
        title: t("guardian.title"),
        right: g?.available === false ? el(Badge, { tone: "bad" }, t("guardian.unavailable"))
        ...
        g ? el(React.Fragment, null,
          ...
          el("div", { className: "dshops-row" },
            el(Btn, { primary: true, disabled: guardBusy || g.available !== true, onClick: runPreflight }, guardBusy ? t("guardian.preflighting") : t("guardian.preflight")),
            el(Btn, { danger: true, disabled: guardBusy || g.available !== true || !g.lastKnownGood, onClick: recover }, t("guardian.recover")),
          ),
