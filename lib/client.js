    ...
    return el("div", { className: "dshops-grid" },
      ...
      el(Card, {
        ...
        g ? el(React.Fragment, null,
          ...
          el("div", { className: "dshops-row" },
            el(Btn, { primary: true, disabled: guardBusy, onClick: runPreflight }, guardBusy ? t("guardian.preflighting") : t("guardian.preflight")),
            el(Btn, { danger: true, disabled: guardBusy || !g.lastKnownGood, onClick: recover }, t("guardian.recover")),
          ),
